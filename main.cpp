...
int main()
{
	...
	*/
	...
	/*for( int y = 0; y < yField; y++ )
	{
		...
		piece.tileShape.setPosition( 0 * blockHeight, y * blockWidth );
		mesh[ 0 ] [ y ] = piece;
	}*/
	...
	RenderWindow window( VideoMode( g_width, g_height ), "tesciory" ); // 1000, 500
...
//
//
//	//View view( Vector2f( 1000.0f, 500.0f ), Vector2f( 1000.0f, 500.0f ) );
//
//	
//
//
